...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$startRuleFunctions = { Notes: peg$parseNotes },
        peg$startRuleFunction  = peg$parseNotes,
        ...
        peg$c9 = peg$otherExpectation("note"),
        peg$c10 = function(note) {
          		return note;
            },
        peg$c11 = function(halfed) {
              return halfed;
            },
        peg$c12 = function(dotted) {
        	  return dotted;
           },
        peg$c13 = peg$otherExpectation("dotted"),
        peg$c14 = ".",
        peg$c15 = peg$literalExpectation(".", false),
        peg$c16 = function(first, next) {
        ...
        peg$c17 = peg$otherExpectation("fixed_note"),
        peg$c18 = "/",
        peg$c19 = peg$literalExpectation("/", false),
        peg$c20 = function(note) {
                note.duration = 1;
                note.conn = ["open"];
                return note;
            },
        ...
        peg$c24 = function(note) {
              note.duration = 1;
              note.conn = [];
              return note;
            },
        peg$c25 = peg$otherExpectation("modified_pitch"),
        peg$c26 = function(acc, pitch, octave) {
                pitch.accidental = acc;
                pitch.octave = octave;
                return pitch;
            },
        peg$c27 = function(acc, pitch) {
          	   	pitch.accidental = acc;
                return pitch;
            },
        peg$c28 = function(pitch, octave) {
            	pitch.octave = octave;
            	return pitch
            },
        peg$c29 = function(pitch) {
              	return pitch
            },
        peg$c30 = peg$otherExpectation("octave"),
        peg$c31 = /^[,']/,
        peg$c32 = peg$classExpectation([",", "'"], false, false),
        peg$c33 = /^[1-3]/,
        peg$c34 = peg$classExpectation([["1", "3"]], false, false),
        peg$c35 = function() {
            let oct = text();
            let obj = {};
        ...
        peg$c36 = peg$otherExpectation("accidental"),
        peg$c37 = /^[b#n]/,
        peg$c38 = peg$classExpectation(["b", "#", "n"], false, false),
        peg$c39 = function() { return text(); },
        peg$c40 = peg$otherExpectation("pitch"),
        peg$c41 = /^[0-7]/,
        peg$c42 = peg$classExpectation([["0", "7"]], false, false),
        peg$c43 = function() { return {pitch : parseInt(text())}; },
    ...
    function peg$parseModifiedPitch() {
      var s0, s1, s2, s3;
